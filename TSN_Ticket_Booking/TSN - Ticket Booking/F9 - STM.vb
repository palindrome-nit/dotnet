...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(F9___STM))
        ...
        'TextBox2
        '
        Me.TextBox2.Location = New System.Drawing.Point(208, 117)
        ...
        Me.ToolBar1.Size = New System.Drawing.Size(408, 33)
        Me.ToolBar1.TabIndex = 124
        '
        'ToolBarButton14
        '
        ...
        Me.Label2.Location = New System.Drawing.Point(104, 117)
        ...
        'TextBox1
        '
        Me.TextBox1.Location = New System.Drawing.Point(208, 85)
        ...
        Me.Label12.Location = New System.Drawing.Point(104, 85)
        Me.Label12.Name = "Label12"
        Me.Label12.Size = New System.Drawing.Size(68, 18)
        Me.Label12.TabIndex = 122
        Me.Label12.Text = "State No"
        '
        'F9___STM
        '
        ...
        Me.ControlBox = False
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.ToolBar1, Me.Label1, Me.Label2, Me.TextBox1, Me.Label12, Me.TextBox2})
        Me.Name = "F9___STM"
...
#End Region
    ...
    Private Sub F9__STM_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            rs.Open("select * from state_mast", cn, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
            'ShowRS()
    ...
    Private Sub ToolBar1_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles ToolBar1.ButtonClick
        If ToolBar1.Buttons.IndexOf(e.Button) = 2 Then
            'Add
            Clear()
            rs1.Open("select nvl(max(state_code),0) from state_mast", cn, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
        ...
        ElseIf ToolBar1.Buttons.IndexOf(e.Button) = 5 Then
            ...
            Dim id As Integer
            Try
                id = InputBox("Enter the state Code")
                rs.Requery()
                rs.MoveFirst()
                rs.Find("state_code=" & id)
                If rs.EOF Then
        ...
        ElseIf ToolBar1.Buttons.IndexOf(e.Button) = 8 Then
            ...
            Dim msg As String
            Try
                id1 = InputBox("Enter the state Code")
                rs.Requery()
                rs.MoveFirst()
                rs.Find("state_code=" & id1)
                If rs.EOF Then
                    MessageBox.Show("Record not found", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                Else
                    ShowRS()
