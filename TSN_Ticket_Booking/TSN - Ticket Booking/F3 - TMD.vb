...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(F3___TMD))
        ...
        Me.Label1.Text = " Transport Transaction Master"
        '
        'ToolBarButton10
        '
        ...
        Me.Picture1.Location = New System.Drawing.Point(272, 152)
        ...
        'Button3
        '
        Me.Button3.Location = New System.Drawing.Point(477, 195)
        ...
        'Button2
        '
        Me.Button2.Location = New System.Drawing.Point(478, 153)
        ...
        Me.Label6.Location = New System.Drawing.Point(37, 245)
        Me.Label6.Name = "Label6"
        Me.Label6.Size = New System.Drawing.Size(118, 26)
        Me.Label6.TabIndex = 130
        Me.Label6.Text = "Transport ID"
        '
        'Label7
        '
        ...
        Me.Label7.Text = "Payment Mode ID"
        '
        'TextBox5
        '
        Me.TextBox5.Location = New System.Drawing.Point(152, 246)
        ...
        'TextBox6
        '
        Me.TextBox6.Location = New System.Drawing.Point(151, 284)
        ...
        Me.Label8.Location = New System.Drawing.Point(269, 128)
        Me.Label8.Name = "Label8"
        Me.Label8.Size = New System.Drawing.Size(113, 22)
        Me.Label8.TabIndex = 134
        Me.Label8.Text = "Booking No"
        '
        'Label9
        '
        ...
        Me.Label9.Location = New System.Drawing.Point(370, 126)
        Me.Label9.Name = "Label9"
        Me.Label9.Size = New System.Drawing.Size(80, 23)
        Me.Label9.TabIndex = 135
        Me.Label9.Text = "Seat Nos"
        '
        'F3___TMD
        '
        Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
        Me.ClientSize = New System.Drawing.Size(563, 333)
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.Label9, Me.Label8, Me.TextBox6, Me.TextBox5, Me.Label7, Me.Label6, Me.TextBox4, Me.TextBox3, Me.Label5, Me.ToolBar1, Me.TextBox1, Me.Label4, Me.Label2, Me.Label1, Me.TextBox2, Me.Label3, Me.Picture1, Me.Button3, Me.Button2})
        Me.Name = "F3___TMD"
        Me.Text = "F6__RMD"
...
#End Region
    ...
    Private Sub ToolBar1_ButtonClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.ToolBarButtonClickEventArgs) Handles ToolBar1.ButtonClick
        If ToolBar1.Buttons.IndexOf(e.Button) = 2 Then
            ...
            Clear()
            Call empary()
            rs2.Open("select nvl(max(book_no),0) from trans_tranc_mast", cn, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
        ...
        ElseIf ToolBar1.Buttons.IndexOf(e.Button) = 3 Then
            ...
            rs.Fields(5).Value = TextBox6.Text
            rs.Update()
            For j = 0 To i
                rs1.AddNew()
        ...
        ElseIf ToolBar1.Buttons.IndexOf(e.Button) = 6 Then
            ...
            rs.Fields(5).Value = TextBox6.Text
            rs.Update()
            temp.Open("select * from trans_tranc_details where book_no = " & TextBox1.Text, cn, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
            While Not temp.EOF
                temp.Fields(0).Value = Text1(i).Text
                temp.Fields(1).Value = Text2(i).Text
                temp.MoveNext()
            End While
        ...
        ElseIf ToolBar1.Buttons.IndexOf(e.Button) = 8 Then
            ...
            Dim i As Integer
            Try
                i = InputBox("Enter the  Booking Number", "Modify")
                rs.Requery()
                rs.MoveFirst()
                rs.Find("book_no" & i)
                If rs.EOF Then
    ...
    Private Sub F6__RMD_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        rs.Open("Select * from trans_tranc_mast", cn, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
        rs1.Open("Select * from trans_tranc_details", cn, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockOptimistic)
        Call Clear()
    End Sub
